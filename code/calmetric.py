...
DATE = "20230431"
read_path = "./ZReconstruction/DeepLearning/Dataset/"+DATE+"Dataset/test/input"
label_path = "./ZReconstruction/DeepLearning/Dataset/"+DATE+"Dataset/test/label"
pred_path = "./ZReconstruction/DeepLearning/Unet-Segmentation-Pytorch-Nest-of-Unets/model/gen_images"
