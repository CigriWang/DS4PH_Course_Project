...
def eval_image(image_type, model_type):
    def self_transforms():
    ...
    test_folderP = "./dataset/test/"+image_type+"/input/*"
    test_folderL = "./dataset/test/"+image_type+"/label/*"
    pth_model_path = "./model_"+model_type+"/UNet_D_600_32/best.pth"
    epoch = 10
    upper_ = 0.015
    lower_ = -0.015
    ...
    model_test.load_state_dict(torch.load(pth_model_path, map_location=device)
    )
